...
<body>
    ...
    <TABLE BORDER=1 class="menu sombra">
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            echo "<td>" . $di . "</td>";
            echo "<td><center>";
            echo "<a onclick=\"return confirmSubmit()\" href=\"tablas/borrar2new.php?id_comidas=" . $id . "\"><img src='tablas/eliminar.bmp' width='14' height='14' border='0'></a>";
            echo "</center></td>";
            echo "<td><center>";
            echo "<a href=\"tablas/actualizanew.php?id_comidas=" . $id . "\"><img src='tablas/actualiza.jpg' width='25' height='25' border='0'></a>";
            echo "</center></td>";
            echo "</tr>";
        }
